...
/// <summary>Correspondance code de département français → nom (métropole, Corse, DOM).</summary>
public static class FrenchDepartments
{
    ...
    public static string Name(string code) => Names.TryGetValue(code, out var n) ? n : "Département inconnu";
}
